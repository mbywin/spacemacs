;;; keybindings.el --- miaoboyong Layer packages File for Spacemacs
;;
;; Copyright (c) 2015-2016 miaoboyong
;;
;; Author: miaoboyong <guanghui8827@gmail.com>
;; URL: https://github.com/miaoboyong/spacemacs-private
;;
...
(global-set-key [(shift return)] 'miaoboyong/smart-open-line)
(global-set-key (kbd "s-/") 'hippie-expand)
(global-set-key (kbd "C-c a") 'org-agenda)
(define-key global-map (kbd "C-c y") 'youdao-dictionary-search-at-point+)
(define-key global-map (kbd "<f9>") 'org-capture)
(define-key global-map (kbd "C-c t") 'org-capture)
(define-key global-map (kbd "<f8>") 'miaoboyong/show-current-buffer-major-mode)
...
(global-set-key (kbd "s-d") 'miaoboyong/my-mc-mark-next-like-this)
(bind-key* "s-r" 'mc/reverse-regions)
(global-set-key (kbd "<f5>") 'miaoboyong/run-current-file)
...
(when (spacemacs/system-is-mac)
 (spacemacs/set-leader-keys "o!" 'miaoboyong/iterm-shell-command))
...
;; (bind-key* "s-r" 'miaoboyong/browser-refresh--chrome-applescript)
(bind-key* "s-;" 'miaoboyong/insert-semicolon-at-the-end-of-this-line)
(bind-key* "C-s-;" 'miaoboyong/delete-semicolon-at-the-end-of-this-line)
(bind-key* "s-," 'miaoboyong/insert-comma-at-the-end-of-this-line)
;; (bind-key* "C-s-," 'miaoboyong/delete-comma-at-the-end-of-this-line)
(bind-key* "C-c l" 'miaoboyong/insert-chrome-current-tab-url)
;; (bind-key* "M-s o" 'occur-dwim)
(bind-key* "C-=" 'er/expand-region)
(bind-key* "M--" 'miaoboyong/goto-match-paren)
...
(global-set-key (kbd "<f1>") 'miaoboyong/helm-hotspots)
(spacemacs/set-leader-keys "oo" 'miaoboyong/helm-hotspots)

(spacemacs/set-leader-keys "oc" 'my-auto-update-tags-when-save)
(spacemacs/set-leader-keys "op" 'miaoboyong/org-save-and-export)
(spacemacs/set-leader-keys "fR" 'miaoboyong/rename-file-and-buffer)
...
(spacemacs/set-leader-keys "oac" 'miaoboyong/browser-refresh--chrome-applescript)
...
(spacemacs/set-leader-keys "sj" 'miaoboyong/counsel-imenu)
;; deal with BOM
...
(spacemacs/set-leader-keys "oll" 'miaoboyong/load-my-layout)
(spacemacs/set-leader-keys "ols" 'miaoboyong/save-my-layout)
;; (spacemacs/set-leader-keys "ob" 'popwin:display-last-buffer)
(spacemacs/set-leader-keys "oy" 'youdao-dictionary-search-at-point+)

(bind-key* "s-p" 'find-file-in-project)
(spacemacs/set-leader-keys "os" 'miaoboyong/search-in-fireball)
