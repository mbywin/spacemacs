...
(defconst miaoboyong-ui-packages
  '(
...
(defun miaoboyong-ui/init-zilong-mode-line ()
  (defun miaoboyong/display-mode-indent-width ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (propertize
                          ...
                          'font-lock-type-face))
                 " "
                 '(:eval (miaoboyong/update-persp-name))
                 ...
                 '(:eval (miaoboyong/display-mode-indent-width))
                 ;; line and column
...
(defun miaoboyong-ui/post-init-diminish ()
  (progn
...
(defun miaoboyong-ui/post-init-spaceline ()
...
(defun miaoboyong-ui/init-beacon ()
  (use-package beacon
    :init
    (progn
...
(defun miaoboyong-ui/init-evil-vimish-fold ()
...
(defun miaoboyong-ui/post-init-hl-anything ()
  (progn
...
(defun miaoboyong-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
;; (defun miaoboyong-ui/post-init-popwin ()
;;   (progn
;;     (push "*miaoboyong/run-current-file output*" popwin:special-display-config)
;;     (delete "*Async Shell Command*" popwin:special-display-config)))

(defun miaoboyong-ui/post-init-whitespace ()
  (progn
