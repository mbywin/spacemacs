...
(defun miaoboyong-misc/init-highlight-global ()
...
(defun miaoboyong-misc/post-init-golden-ratio ()
...
(defun miaoboyong-misc/post-init-ranger ()
...
(defun miaoboyong-misc/init-helm-ag ()
  (use-package helm-ag
    :defer t
    :init
    (progn
...
(defun miaoboyong-misc/post-init-gist ()
  (use-package gist
    :defer t
    :init
...
(defun miaoboyong-misc/init-peep-dired ()
...
(defun miaoboyong-misc/post-init-flyspell-correct ()
  (progn
    (with-eval-after-load 'flyspell
      (define-key flyspell-mode-map (kbd "C-;") 'flyspell-correct-previous-word-generic))
    (setq flyspell-correct-interface 'flyspell-correct-ivy)))

(defun miaoboyong-misc/post-init-smartparens ()
...
(defun miaoboyong-misc/init-tiny ()
  (use-package tiny
    :defer t
    :init
    (spacemacs/set-leader-keys "oe" 'tiny-expand)))

(defun miaoboyong-misc/post-init-helm ()
...
(defun miaoboyong-misc/init-helm-github-stars ()
  (use-package helm-github-stars
    :commands (helm-github-stars)
    :init
    (setq helm-github-stars-username "miaoboyong")))




(defun miaoboyong-misc/post-init-fcitx ()
  (fcitx-aggressive-setup))

(defun miaoboyong-misc/post-init-command-log ()
...
(defun miaoboyong-misc/init-litable ()
  (use-package litable
    :init
    :defer t))

(defun miaoboyong-misc/init-osx-dictionary ()
...
(defun miaoboyong-misc/init-4clojure ()
...
(defun miaoboyong-misc/post-init-avy ()
  (progn
    (global-set-key (kbd "C-s-'") 'avy-goto-char-2)
    (global-set-key (kbd "M-'") 'avy-goto-char-2)))

(defun miaoboyong-misc/post-init-ace-window ()
  (global-set-key (kbd "C-x C-o") #'ace-window))

(defun miaoboyong-misc/init-discover-my-major ()
...
(defun miaoboyong-misc/post-init-elfeed ()
  (use-package elfeed
    :init
...
(defun miaoboyong-misc/post-init-evil ()
  (progn
    ...
    (define-key evil-normal-state-map
      (kbd "Y") 'miaoboyong/yank-to-end-of-line)
    ...
    (define-key evil-visual-state-map (kbd "C-r") 'miaoboyong/evil-quick-replace)
    ...
    ;; (defadvice evil-insert-state (around miaoboyong/holy-mode activate)
...
(defun miaoboyong-misc/init-visual-regexp ()
  (use-package visual-regexp
    :commands (vr/replace vr/query-replace)))

(defun miaoboyong-misc/init-visual-regexp-steroids ()
...
(defun miaoboyong-misc/init-multiple-cursors ()
...
;;; Occasionally useful
    ...
    (setq mc/cmds-to-run-once
          '(
            counsel-M-x
            miaoboyong/my-mc-mark-next-like-this))
...
(defun miaoboyong-misc/post-init-prodigy ()
  (progn
    (prodigy-define-tag
      :name 'jekyll
...
(defun miaoboyong-misc/init-moz-controller ()
...
(defun miaoboyong-misc/init-ag ()
  (use-package ag
    :init))

(defun miaoboyong-misc/post-init-erc ()
  (progn
    (add-hook 'erc-text-matched-hook 'my-erc-hook)
    (spaceline-toggle-erc-track-off)))

(defun miaoboyong-misc/init-wrap-region ()
...
(defun miaoboyong-misc/init-keyfreq ()
  (use-package keyfreq
    :init
    (progn
      (keyfreq-mode t)
...
(defun miaoboyong-misc/post-init-swiper ()
