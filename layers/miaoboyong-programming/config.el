...
(add-hook 'term-mode-hook 'miaoboyong/ash-term-hooks)
...
(defun miaoboyong/untabify-buffer ()
  (interactive)
  (save-excursion
...
(add-hook 'c++-mode-hook
          #'(lambda ()
             (add-hook 'write-contents-hooks
                       'miaoboyong/untabify-buffer nil t)))
...
(defmacro miaoboyong|toggle-company-backends (backend)
