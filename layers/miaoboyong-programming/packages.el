;;; packages.el --- miaoboyong Layer packages File for Spacemacs
;;
...
(defun miaoboyong-programming/post-init-cider ()
  ...
  (global-set-key (kbd "C-c C-f") #'miaoboyong/cider-figwheel-repl))

(defun miaoboyong-programming/post-init-graphviz-dot-mode ()
  (with-eval-after-load 'graphviz-dot-mode
      (require 'company-keywords)
      (push '(graphviz-dot-mode  "digraph" "node" "shape" "subgraph" "label" "edge" "bgcolor" "style" "record") company-keywords-alist)))

(defun miaoboyong-programming/post-init-dumb-jump ()
...
(defun miaoboyong-programming/post-init-clojure-mode ()
  )

(defun miaoboyong-programming/post-init-emacs-lisp ()
    (remove-hook 'emacs-lisp-mode-hook 'auto-compile-mode))

(defun miaoboyong-programming/post-init-python ()
  (add-hook 'python-mode-hook #'(lambda () (modify-syntax-entry ?_ "w")))
  ;; if you use pyton3, then you could comment the following line
  (setq python-shell-interpreter "python"))

(defun miaoboyong-programming/post-init-js-doc ()
  (setq js-doc-mail-address "mbywin@gmail.com"
        js-doc-author (format "mbywin <%s>" js-doc-mail-address)
        js-doc-url "http://www.miaoboyong.com"
        js-doc-license "MIT")
...
(defun miaoboyong-programming/init-ctags-update ()
...
;; (defun miaoboyong-programming/init-js-comint ()
...
(defun miaoboyong-programming/post-init-web-mode ()
...
(defun miaoboyong-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'miaoboyong/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun miaoboyong-programming/post-init-racket-mode ()
  (progn
...
(defun miaoboyong-programming/post-init-json-mode ()
...
(defun miaoboyong-programming/init-nodejs-repl ()
  (use-package nodejs-repl
    :init
    :defer t))

(defun miaoboyong-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun miaoboyong-programming/init-lispy ()
  (use-package lispy
    :defer t
    :init
    (progn
...
(defun miaoboyong-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun miaoboyong-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun miaoboyong-programming/post-init-cmake-mode ()
  (progn
...
(defun miaoboyong-programming/post-init-flycheck ()
...
(defun miaoboyong-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun miaoboyong-programming/init-impatient-mode ()
  "Initialize impatient mode"
  (use-package impatient-mode
    :init
    (progn
      (add-hook 'web-mode-hook 'miaoboyong/impatient-mode-hook)
...
(defun miaoboyong-programming/post-init-js2-refactor ()
  (progn
    (spacemacs/set-leader-keys-for-major-mode 'js2-mode
      "r>" 'js2r-forward-slurp
      "r<" 'js2r-forward-barf)))

(defun miaoboyong-programming/post-init-js2-mode ()
  (progn
    ...
    (miaoboyong|toggle-company-backends company-tern)
...
(defun miaoboyong-programming/post-init-css-mode ()
  (progn
...
(defun miaoboyong-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function miaoboyong/init-<extension-name>
;;
(defun miaoboyong-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun miaoboyong-programming/init-nodejs-repl-eval ()
...
(defun miaoboyong-programming/post-init-lua-mode ()
  (progn
...
(defun miaoboyong-programming/post-init-cc-mode ()
  (progn
...
(defun miaoboyong-programming/init-flycheck-clojure ()
